...
#python run_scGPT_pipeline.py --experiment Chu_CD4T_validation
python run_scGPT_pipeline.py --experiment Chu_CD8T_validation
#python run_scGPT_pipeline.py --experiment Zheng_CD4_to_Chu_CD4
#python run_scGPT_pipeline.py --experiment GSE179994_CD8_to_HNSC_CD8
#python run_scGPT_pipeline.py --experiment ProjecTILs_CD8_to_HNSC_CD8
python run_scGPT_pipeline.py --experiment GSE179994_CD8_to_Chu_CD8T
python run_scGPT_pipeline.py --experiment ProjecTILs_CD8_to_Chu_CD8T
