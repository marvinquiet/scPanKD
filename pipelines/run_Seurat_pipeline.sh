...
#Rscript run_Seurat_pipeline.R --experiment Chu_CD4T_validation
#Rscript run_Seurat_pipeline.R --experiment Chu_CD8T_validation
#Rscript run_Seurat_pipeline.R --experiment Zheng_CD4_to_Chu_CD4
